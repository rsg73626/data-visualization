 ...
 */
function drawDispersionChart(title, chartAreaWidth, chartAreaHeight, column1, column2, horizontalLabel, verticalLabel) {
...
function drawDispersionChartFromCSV(filePath, width, height, column1, column2) {
    ...
    d3.dsv(';', filePath, null, parse).then(function(data) {
        if (data.length > 0 || c1.length != c2.length) {
            ...
            drawDispersionChart('Dispersion chart from ' + filePath, width, height, c1, c2, c1Key, c2Key) 
        } else {
